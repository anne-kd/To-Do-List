...
const DOMDay = document.querySelector("#date-day") as HTMLElement;
const DOMWeekDay = document.querySelector("#date-weekday") as HTMLElement;
const DOMMonth = document.querySelector("#date-month") as HTMLElement;
...
const DOMInput = (<HTMLInputElement>document.getElementById("listinput")) as HTMLInputElement;
const DOMList = document.querySelector(".list") as HTMLElement;
const DOMButton = document.querySelector(".add-button") as HTMLButtonElement;
...
function addTask() : void{
    ...
    let DOMRead = document.querySelector("#read") as HTMLElement;
